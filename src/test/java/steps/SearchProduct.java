...
public class SearchProduct extends Base {
    private Base base;
    private Home home;  //importar a Home , List e Product
    private List list;
    ...
    public void iSearch(String product)  {
        home.setBtnSearchEnter(product);
    }
    ...
    public void showTheTitleAndPrice(String product, String price)  {
        // Validar o nome da guia
        assertEquals(product + "- Produto pet em promoção | Petz", productClass.readTitleTab());
